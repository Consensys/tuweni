...
class BytesSSZReaderTest {
  ...
  void shouldRoundtripBytesVararg() {
    List<Bytes> toWrite = Arrays.asList(Bytes.random(48), Bytes.random(48), Bytes.random(48));
  ...
  void shouldRoundtripHomogenousBytesList() {
    List<Bytes> toWrite = Arrays.asList(Bytes.random(32), Bytes.random(32), Bytes.random(32));
